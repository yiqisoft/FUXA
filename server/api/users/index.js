...
module.exports = {
  ...
  app: function () {
     ...
     */
    usersApp.get('/scada/api/users', secureFnc, function (req, res) {
     ...
     */
    usersApp.post('/scada/api/users', secureFnc, function (req, res, next) {
      var groups = checkGroupsFnc(req);
      if (res.statusCode === 403) {
     ...
     */
    usersApp.delete('/scada/api/users', secureFnc, function (req, res, next) {
      var groups = checkGroupsFnc(req);
      if (res.statusCode === 403) {
