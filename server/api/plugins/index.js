...
module.exports = {
  ...
  app: function () {
     ...
     */
    pluginsApp.get('/scada/api/plugins', secureFnc, function (req, res) {
     ...
     * Install the plugin
     */
    pluginsApp.post('/scada/api/plugins', secureFnc, function (req, res, next) {
      var groups = checkGroupsFnc(req);
      if (res.statusCode === 403) {
        ...
        runtime.plugins
          .addPlugin(req.body.params, true)
          .then(function (data) {
